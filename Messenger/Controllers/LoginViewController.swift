...
class LoginViewController: UIViewController {
    ...
    private let imageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "message1")
    ...
    override func viewDidLayoutSubviews() {
        ...
        emailField.frame = CGRect(x: 30, y: imageView.bottom + 20,
                                  width: scrollView.width - 60, height: 52)
        passwordField.frame = CGRect(x: 30, y: emailField.bottom + 20,
                                  width: scrollView.width - 60, height: 52)
        loginButton.frame = CGRect(x: 30, y: passwordField.bottom + 20,
                                  width: scrollView.width - 60, height: 52)
    }
